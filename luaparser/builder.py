...
class Builder:
    ...
    def get_inline_comment(self) -> Comment | None:
        if self.comments:
    ...
    def parse_chunk(self) -> Chunk | None:
    ...
    def parse_stat(self) -> Statement | None:
        comments = self.get_comments()
    ...
    def parse_var(self, is_statement=False) -> Node | bool:
        self.save()
    ...
    def parse_do_block(self) -> Block | bool:
        self.save()
    ...
    def parse_while_stat(self) -> While | bool:
        self.save()
    ...
    def parse_repeat_stat(self) -> Repeat | bool:
        self.save()
    ...
    def parse_local(self) -> Node | bool:
        self.save()
        self._expected = []
    ...
    def parse_goto_stat(self) -> Goto | bool:
        self.save()
    ...
    def parse_if_stat(self) -> If | bool:
        self.save()
    ...
    def parse_elseif_stat(self) -> ElseIf | bool:
        self.save()
    ...
    def parse_else_stat(self) -> Block | bool:
        self.save()
    ...
    def parse_for_stat(self) -> Fornum | Forin | bool:
        self.save()
    ...
    def parse_function(self) -> Method | Function | bool:
        self.save()
        self._expected = []
    ...
    def parse_names(self) -> Name | Index | bool:
        self.save()
        if self.next_is_rc(Tokens.NAME):
            root = Name(
                self.text,
    ...
    def parse_label(self) -> Label | bool:
        self.save()
    ...
    def parse_callee(self) -> Expression | bool:
        self.save()
        if self.next_is_rc(Tokens.OPAR):
            expr = self.parse_expr()
            if expr:
    ...
    def parse_expr(self) -> Expression | bool:
        return self.parse_or_expr()

    def parse_or_expr(self) -> Expression | bool:
        self.save()
    ...
    def parse_and_expr(self) -> Expression | bool:
        self.save()
    ...
    def parse_rel_expr(self) -> Expression | bool:
        self.save()
    ...
    def parse_concat_expr(self) -> Expression | bool:
        self.save()
    ...
    def parse_add_expr(self) -> Expression | bool:
        self.save()
    ...
    def parse_mult_expr(self) -> Expression | bool:
        self.save()
    ...
    def parse_bitwise_expr(self) -> Expression | bool:
        self.save()
    ...
    def parse_unary_expr(self) -> Expression | bool:
        self.save()
    ...
    def parse_pow_expr(self) -> Expression | bool:
        self.save()
    ...
    def parse_atom(self) -> Expression | bool:
        atom = self.parse_var()
        if atom:
            return atom
    ...
    def parse_function_literal(self) -> AnonymousFunction | bool:
        self.save()
    ...
    def parse_table_constructor(self, render_last_hidden=True) -> Table | bool:
        self.save()
